                ...
                <div class="box">
                    ...
                    <div class="row" style="padding: 10px;">
                        <div class="col-md-6">
                            ...
                            <a href="<?php echo base_url('admin/question/create') ?>" class="btn btn-primary">Thêm mới</a>
                        </div>
                        <div class="col-md-6">
                                    ...
                                    <tr class="remove_<?php echo $value['id'] ?>">
                                        ...
                                        <td>
                                            <?php if ($value['is_activated'] == 0): ?>
                                                <a href="javascript:void(0);" onclick="deactive('<?php echo $controller; ?>', <?php echo $value['id'] ?>, 'Chăc chắn tắt.')" class="dataActionDelete" title="Tắt câu hỏi"><i class="fa fa-low-vision" aria-hidden="true"></i> </a>
                                            <?php else: ?>
                                                <a href="javascript:void(0);" onclick="active('<?php echo $controller; ?>', <?php echo $value['id'] ?>, 'Chăc chắn bật')" class="dataActionDelete" title="Bật câu hỏi"><i class="fa fa-eye" aria-hidden="true"></i> </a>
                                            <?php endif ?>
                                            <a href="<?php echo base_url('admin/'.$controller.'/edit/'. $value['id']) ?>" class="dataActionEdit"><i class="fa fa-pencil" aria-hidden="true"></i> </a>
                                            <a href="javascript:void(0);" onclick="remove('question', <?php echo $value['id'] ?>)" class="dataActionDelete"><i class="fa fa-remove" aria-hidden="true"></i> </a>
                                        </td>
...
<script type="text/javascript">
    ...
    document.querySelector('.modal-footer a').setAttribute('href',HOSTNAMEADMIN+'/question/create/'+document.getElementById('select_templates').value);
    function submit_shared(val){
        document.querySelector('.modal-footer a').setAttribute('href',HOSTNAMEADMIN+'/question/create/'+val);
    }
</script>
